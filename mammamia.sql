CREATE DATABASE  IF NOT EXISTS `mammamia` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mammamia`;
...
--
-- Table structure for table `addrlist`
--
...
--
-- Dumping data for table `addrlist`
--

LOCK TABLES `addrlist` WRITE;
